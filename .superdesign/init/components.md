...
Component library: shadcn/ui primitives in `packages/ui`
CSS approach: Tailwind CSS v4 + CSS variables

## Button
- File: `packages/ui/src/components/button.tsx`
- Description: Shared UI primitive used across the app.
- Key props: See exported component signature in source.
